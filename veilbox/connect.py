"""Native cognis-connect emit for veilbox — forward findings to any platform.

Maps veilbox's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    veilbox ... --format json | veilbox-emit --to stix
    veilbox-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
